...
nodejs_version        = "v4.2.1"   # By default "latest" will equal the latest stable version
...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "samryan.co.uk.dev" do |vapro|
  end
